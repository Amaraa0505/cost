...
export const getIcons = (name, color) => {
  const icons = {
    gift: <FaGift size={30} color={color} />,
    home: <FaHome size={30} color={color} />,
    taxi: <FaTaxi size={30} color={color} />,
    taxi: <FaWineGlassAlt size={30} color={color} />,
    food: <FaWineGlassAlt size={30} color={color} />,
  };
  return icons[name];
};
